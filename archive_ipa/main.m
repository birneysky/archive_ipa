...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        for (NSInteger i = 0; i < appConfigs.count; i++) {
            ...
            configInfo.appGuidePageSrcPath = [appItem objectForKey:@"AppGuidePageSrcPath"];
            configInfo.bundleDisplayName = [appItem objectForKey:@"BundleDisplayName"];
            configInfo.version = [appItem objectForKey:@"Version"];
            configInfo.updateURL = [appItem objectForKey:@"UpdateURL"];
            ...
            configInfo.guidePageEnable = [[appItem objectForKey:@"GuidePageEnable"] boolValue];
            configInfo.appIconSrcPath = [appItem objectForKey:@"AppIconSrcPath"];
            configInfo.appProjectPath = [pathes objectForKey:@"AppProjectPath"];
            configInfo.appIconDstPath = [pathes objectForKey:@"AppIconDstPath"];
            configInfo.appGuidePageDstPath = [pathes objectForKey:@"AppGuidePageDstPath"];
