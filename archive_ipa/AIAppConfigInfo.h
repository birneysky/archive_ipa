...
@property (nonatomic,copy) NSString* appGuidePageSrcPath;
...
@property (nonatomic,assign) BOOL guidePageEnable;
...
@property (nonatomic,copy) NSString* appGuidePageDstPath;
